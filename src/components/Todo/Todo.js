...
class Todo extends React.Component {
  ...
  render() {
    ...
    switch (this.state.sorting) {
      case 'Завершенные': sortingItems = this.state.items.filter(item => item.isDone);
      break;
      case 'Незавершенные': sortingItems = this.state.items.filter(item => !item.isDone);
      break;
      case 'Все': sortingItems = this.state.items;
      break;
    };
